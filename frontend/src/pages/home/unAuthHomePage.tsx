...
export const UnAuthHomePage = () => {
  ...
  const dataMock = [
    { id: 1, title: "Rock Classics", category: "Classic Rock", ImageUrl: "https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcSUe-V7A8P_ts4MN2XZkMn1AMAWIJRLcFk32sl097ek8ZfV3QieRiiamiiycqwt" },
    { id: 3, title: "Techno Night", category: "Eletrônica", ImageUrl: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT0LahRPKoPKZZYSMtGHrzRIaPMqtraXzNrDB2gWd33pPTc-RcIUjcT7d1TfAAe" },
  ];
