...
export const CreateAlbumModal = ({ visible, onHide, onSuccess }: CreateAlbumModalProps) => {
      ...
      <div className="flex flex-col space-y-6 p-3">
        <div className="text-center space-y-3">
          <div className="w-14 h-14 bg-black mx-auto flex items-center justify-center rounded-xl">
            <i className="pi pi-compact-disc text-white text-3xl"></i>
          </div>
          <h2 className="text-3xl font-black uppercase tracking-tighter">
            Novo Álbum
          </h2>
          <p className="text-xs text-gray-500 uppercase tracking-wider">
            Preencha os dados do álbum
          </p>
        </div>
